<template>
    ...
    <div class="fixed inset-0 bg-[#f9f9f9] dark:bg-[#131313] bg-[url(images/body/bg_white.png)] dark:bg-[url(images/body/bg_black.png)] bg-fixed grid-container h-full transition-transform duration-500 z-40" :class="{'-translate-y-full' : !isMenuShow}">
