<template>
    ...
    <div class="flex flex-col items-center text-center gap-6 lg:gap-8 uppercase" id="text">
        ...
        <div class="grid grid-cols-2 items-center w-full lg:w-1/2">
            <NuxtImg src="/images/about/1.jpg" alt="" class="-rotate-6 w-full"/>
            <NuxtImg src="/images/about/2.jpg" alt="" class="rotate-6 w-full"/>
        </div>
    </div>
    <CoopOptions/>
    <div class="flex max-lg:flex-col items-center gap-6 lg:gap-8 py-6 lg:py-8 border-y border-[#131313]/60 dark:border-[#f9f9f9]/60">
        ...
        <NuxtImg src="/images/create/main.png" alt="" class="w-full lg:w-1/2"/>
    </div>
    <NewProject/>
