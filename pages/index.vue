<template>
    ...
    <div class="flex flex-col items-center text-center gap-6 lg:gap-8 uppercase" id="text">
        ...
        <div class="grid grid-cols-2 items-center w-full lg:w-1/2">
            <NuxtImg width="368px" height="510px" sizes="100vw" src="/images/about/1.webp" alt="" class="-rotate-6 w-full"/>
            <NuxtImg width="368px" height="510px" sizes="100vw" src="/images/about/2.webp" alt="" class="rotate-6 w-full"/>
        </div>
    </div>
    <CoopOptions/>
